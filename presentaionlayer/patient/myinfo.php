...
<body>
	...
	<form method="post" action="myinfo.php" class="infoP" style="margin-left:-1px; margin-top:0px ;width: 40%;padding: 20px;border :3px solid #207a45 ;background: white; border-radius: 10px 10px 10px 10px;">
